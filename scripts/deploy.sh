...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --max-instances 5 \
    --timeout 300 \
    --set-env-vars "GOOGLE_CLOUD_PROJECT=$PROJECT_ID,GOOGLE_CLOUD_LOCATION=$REGION,MODEL_ID=gemini-flash-latest,ALLOWED_ORIGINS=*,GOOGLE_GENAI_USE_VERTEXAI=FALSE,GOOGLE_API_KEY=YOUR_API_KEY_HERE" \
    --quiet
